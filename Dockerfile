...
RUN env GOOS=$TARGETOS GOARCH=$TARGETARCH go build -modcacherw -o extend-eos-voice-rtc_$TARGETOS-$TARGETARCH
...
COPY --from=builder /build/extend-eos-voice-rtc_$TARGETOS-$TARGETARCH extend-eos-voice-rtc
